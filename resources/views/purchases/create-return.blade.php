...
@section('content')
    <x-card class="shadow-md">
        ...
        <p class="text-sm text-slate-500 mb-4">Retur untuk {{ $purchase->nomor_transaksi }}</p>

        <form method="POST" action="{{ route('purchases.return.store', $purchase) }}" class="space-y-4">
            @csrf
